...
const projectData = {
  ...
  apple: {
    title: "사과 수확 게임",
    tagline: "AI 기획-구현 싸이클 2단계: 실시간 요소와 자원 밸런싱",
    ...
    overview: "퀴즈 게임에서 한 단계 나아가, 실시간 요소(시간 제한)와 자원 수집 밸런싱을 경험한 프로젝트입니다. '제한된 시간 내 최대 효율'이라는 게임 플레이 목표를 설계했습니다.",
    concept: [
      "퀴즈에서 한 단계 나아가, <strong>실시간 요소</strong>를 다뤄본 프로젝트",
      "시간 제한 + 점수 차등(일반/황금/썩은 사과)으로 <strong>리스크-리워드</strong> 설계",
      "이 경험이 로그라이트의 웨이브별 보상량 밸런싱으로 이어짐"
    ],
    systems: [
      {
        title: "시간 제한 수집 시스템",
        why: "실시간 요소가 포함된 게임 루프 설계 경험을 쌓기 위함",
        how: "제한 시간 60초 내 떨어지는 사과를 수집, 종류별 점수 차등",
        what: "일반 사과(10점), 황금 사과(50점), 썩은 사과(-20점)로 리스크-리워드 설계"
      }
    ]
  },
